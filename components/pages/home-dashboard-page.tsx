...
export function HomeDashboardPage() {
  ...
  const text = pickLocalized(language, {
    english: {
      ...
      dashboard: "Dashboard",
      welcome: "welcome to FD Advisor",
      intro:
        "Your hybrid assistant for guided booking, bank exploration, comparison, and quick calculations.",
      goToChat: "Go to Chat",
      ...
      primaryActions: [
        {
          title: "What is FD?",
          description: "Start with simple FD basics",
          message: "What is FD? Explain in simple words",
        },
        {
          title: "Best FD for my amount",
          description: "Get personalized top options",
          message: "Best FD options for 1 year with 1,00,000",
        },
        {
          title: "Compare top banks",
          description: "Check return and safety together",
          message: "Compare FD options for my amount and tenure",
        },
        {
          title: "Calculate returns",
          description: "See maturity and interest instantly",
          route: "/calculator",
        },
      ],
      smartSuggestionsTitle: "Smart Suggestions",
      smartSuggestionsDescription: "Popular intent shortcuts for common users.",
      smartSuggestions: [
        "Best FD options for beginners",
        "Safe FD options with strong trust",
        "High return FD with risk explained",
      ],
      ...
      maturity: "Maturity",
      bottomHint:
        "Not sure where to start? Chat assistant can guide you step-by-step.",
